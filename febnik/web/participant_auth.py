"""Вход участника с сайта: отдельная подписанная cookie (не ключ в общей server-side сессии).

Временные данные шагов /join (до установки cookie) лежат в Starlette Session."""
